...
goto endofperl
@rem ';
#!C:C:\Program Files (x86)\xampp\perl\bin\perl.EXE -w
#line 15
# ====================================================================
#
...
my $CP    = 'C:C:\Program Files (x86)\xampp\perl\bin\perl.EXE -MExtUtils::Command -e cp';
my $CHMOD = 'C:C:\Program Files (x86)\xampp\perl\bin\perl.EXE -MExtUtils::Command -e chmod';
my $RM_F  = 'C:C:\Program Files (x86)\xampp\perl\bin\perl.EXE -MExtUtils::Command -e rm_f';
my $TOUCH = 'C:C:\Program Files (x86)\xampp\perl\bin\perl.EXE -MExtUtils::Command -e touch';

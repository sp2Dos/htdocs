...
require_once( '\xampp\php\pear\data' . PATH_DELIMITER . 'PhpDocumentor/docbuilder/includes/utilities.php' );
...
$ini = phpDocumentor_parse_ini_file('\xampp\php\pear\data' . PATH_DELIMITER . 'PhpDocumentor/phpDocumentor.ini', true);
if (isset($ini['_phpDocumentor_options']['userdir'])) {
    $configdir = $ini['_phpDocumentor_options']['userdir'];
} else {
    $configdir = '\xampp\php\pear\data' . PATH_DELIMITER . 'PhpDocumentor/user';
}
